...
describe("Marketplace", function () {
  ...
  describe("Fee", function () {
    it("Should charge base fee on create listing", async function () {
      ...
      //const baseFee = await swaprFee.getBaseOrderFee(subjectAmount, "0x326C977E6efc84E512bB9C30f76E30c160eD06FB");
      //swaprFee.connect(owner).payNow(baseFee, paymentToken);
      ...
      //expect(await swaprFee.getFeePaid(owner.address, paymentToken)).to.be.equal(baseFee[0]);
